...
write.csv(rf.cv.metric, file='E:/reproductive/models/rf.cv.csv')
write.csv(rf.ind1.metric, file='E:/reproductive/models/rf.ind1.csv')
write.csv(rf.ind2.metric, file='E:/reproductive/models/rf.ind2.csv')
# Save all variables
save.image(file='E:/reproductive/models/rf.models.RData')
