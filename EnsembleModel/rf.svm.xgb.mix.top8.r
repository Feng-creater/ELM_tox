...
train.Dataset.name.vector$xgb <- c('Train_fp_all.PubchemFP.sets', 'Train_fp_all.MACCSFP.sets', 'Train_fp_all.SubFPC.sets')
library(doMC)
...
write.csv(mix.model.cv.metric, file='E:/reproductive/models/rf.svm.xgb.mix.top8.cv.csv')
write.csv(t(finalMixModel.metric.Ind), file='E:/reproductive/models/rf.svm.xgb.mix.top8.Ind.csv')
write.csv(t(finalMixModel.metric.Ind2), file='E:/reproductive/models/rf.svm.xgb.mix.top8.Ind2.csv')
# Save all the variables
save.image(file='E:/reproductive/models/rf.svm.xgb.mix.top8.RData')
