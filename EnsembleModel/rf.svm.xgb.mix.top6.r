...
train.Dataset.name.vector$rf <- c('Train_fp_all.PubchemFP.sets', 'Train_fp_all.MACCSFP.sets')
...
write.csv(mix.model.cv.metric, file='E:/reproductive/models/rf.svm.xgb.mix.top6.cv.csv')
write.csv(t(finalMixModel.metric.Ind), file='E:/reproductive/models/rf.svm.xgb.mix.top6.Ind.csv')
write.csv(t(finalMixModel.metric.Ind2), file='E:/reproductive/models/rf.svm.xgb.mix.top6.Ind2.csv')
# Save all the variables
save.image(file='E:/reproductive/models/rf.svm.xgb.mix.top6.RData')
