...
train.Dataset.name.vector$svm <- c('Train_fp_all.PubchemFP.sets', 'Train_fp_all.MACCSFP.sets', 'Train_fp_all.KRFP.sets', 'Train_fp_all.SubFPC.sets', 'Train_fp_all.KRFPC.sets', 'Train_fp_all.APC2D.sets', 'Train_fp_all.EStateFP.sets', 'Train_fp_all.SubFP.sets')
...
write.csv(mix.model.cv.metric, file='E:/reproductive/models/rf.svm.xgb.mix.top26.cv.csv')
write.csv(t(finalMixModel.metric.Ind), file='E:/reproductive/models/rf.svm.xgb.mix.top26.Ind.csv')
write.csv(t(finalMixModel.metric.Ind2), file='E:/reproductive/models/rf.svm.xgb.mix.top26.Ind2.csv')
# Save all the variables
save.image(file='E:/reproductive/models/rf.svm.xgb.mix.top26.RData')
