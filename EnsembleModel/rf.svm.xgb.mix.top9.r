# Install/Load required packageslibrary(dplyr)
library(caret)
...
train.Dataset.name.vector$rf <- c('Train_fp_all.PubchemFP.sets', 'Train_fp_all.MACCSFP.sets', 'Train_fp_all.SubFPC.sets')
train.Dataset.name.vector$svm <- c('Train_fp_all.PubchemFP.sets', 'Train_fp_all.MACCSFP.sets')
train.Dataset.name.vector$xgb <- c('Train_fp_all.PubchemFP.sets', 'Train_fp_all.MACCSFP.sets', 'Train_fp_all.SubFPC.sets', 'Train_fp_all.APC2D.sets')
library(doMC)
...
write.csv(mix.model.cv.metric, file='E:/reproductive/models/rf.svm.xgb.mix.top9.cv.csv')
write.csv(t(finalMixModel.metric.Ind), file='E:/reproductive/models/rf.svm.xgb.mix.top9.Ind.csv')
write.csv(t(finalMixModel.metric.Ind2), file='E:/reproductive/models/rf.svm.xgb.mix.top9.Ind2.csv')
# Save all the variables
save.image(file='E:/reproductive/models/rf.svm.xgb.mix.top9.RData')
